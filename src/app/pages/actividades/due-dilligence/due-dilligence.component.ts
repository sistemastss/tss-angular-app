...
@Component({
  ...
  templateUrl: './due-dilligence.component.html',
  styleUrls: ['./due-dilligence.component.css']
})
export class DueDilligenceComponent extends ActividadClass implements OnInit {
